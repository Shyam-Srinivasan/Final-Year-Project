            ...
            <Container fluid>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="ms-auto">
                        ...
                        <Nav.Link as={Link} to="/shops">Orders</Nav.Link>
                        <Nav.Link as={Link} to="/shops">Payment</Nav.Link>
                        <Nav.Link as={Link} to="/shops">Feedback</Nav.Link>
                        <Nav.Link as={Link} to="/shops">Analytics</Nav.Link>
                        <Nav.Link as={Link} to="/shops">Setting</Nav.Link>
